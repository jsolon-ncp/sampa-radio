...
save "data/table1_blandaltman_results_cohort_reg_all.dta", replace
...
use "`results'", clear
save "data/table1_blandaltman_results_cohort_reg_cohort.dta", replace
...
use "data/table1_blandaltman_results_cohort_reg_cohort.dta", clear

//Append the total computation 
append using "data/table1_blandaltman_results_cohort_reg_all.dta"
...
save "data/table1_blandaltman_results_cohort_reg_cohort_beta1.dta", replace
...
putdocx text ("Table 1.2: Intra-rater bias estimate (regression)")

putdocx table out3_uni_gsem=data(cohort reader statbody_tail statbody_trans statcc_body statcc_head stathead_ap stathead_trans stattail_trans statvol), halign(center) varnames layout(autofitc) border(all, nil) width(100%) 
...
putdocx save "report/table_1.2.docx", replace
...
save "data/table1_blandaltman_results_cohort_reg_cohort_beta0.dta", replace
...
putdocx begin, pagesize(A4) landscape
putdocx paragraph, font("Arial", 12)
putdocx text ("Table 1.3: Intra-rater regression intercept estimate")
...
putdocx save "report/table_1.3.docx", replace
