...
* CREATE A COUNT VARIABLE - modify accordingly - this should count the analysis dataset for the table 
...
label variable hgb "Haemoglobin  ; Median(p25 - p75)"
...
collect create counts
collect get: table (region), stat(count age) name(count)
...
collect layout 
	...
	collect layout (var) (`scol'#`col'#result[column1 column4])
		...
		(`scol'#`col'#result[column1 column4])
