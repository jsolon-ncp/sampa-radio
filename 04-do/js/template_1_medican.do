...
* This creates a collection and names it c1. Stata saves to a default collection called "default"
collect clear
...
table (var)(agegrp x) , ///
	...
	statistic(p25 bp_before bp_after) ///
	statistic(p75 bp_before bp_after) ///
...
collect style cell result[column1]#var[bp_before bp_after], nformat("%4.1f")

* Add IQR formatting to p25 and p75 separately:
collect style cell result[column2]#var[bp_before bp_after], nformat("%4.1f") sformat("(%s -")
collect style cell result[column3]#var[bp_before bp_after], nformat("%4.1f") sformat("%s)")
...
collect composite define column4 = column2 column3
